...
@section('content-header', 'Update Merchant')
            ...
            <form action="{{ route('merchants.update', $merchant) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="first_name" class="form-control @error('first_name') is-invalid @enderror"
                           id="first_name"
                           placeholder="First Name" value="{{ old('first_name', $merchant->first_name) }}">
                    @error('first_name')
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="last_name" class="form-control @error('last_name') is-invalid @enderror"
                           id="last_name"
                           placeholder="Last Name" value="{{ old('last_name', $merchant->last_name) }}">
                    @error('last_name')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="email" class="form-control @error('email') is-invalid @enderror" id="email"
                           placeholder="Email" value="{{ old('email', $merchant->email) }}">
                    @error('email')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="phone" class="form-control @error('phone') is-invalid @enderror" id="phone"
                           placeholder="Phone" value="{{ old('phone', $merchant->phone) }}">
                    @error('phone')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="address" class="form-control @error('address') is-invalid @enderror"
                           id="address"
                           placeholder="Address" value="{{ old('address', $merchant->address) }}">
                    @error('address')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
                ...
                <div class="form-group">
                    ...
                    <?php if($merchant->avatar):?>
                    <img src="{{$merchant->getAvatarUrl()}}" width="20%" /><br/><br/>
                ...
                <div class="form-group">
                    ...
                    <?php if($merchant->header_image):?>
                    <img src="{{$merchant->getHeaderImageUrl()}}" width="70%" height="20%"/><br/><br/>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="tagline" class="form-control @error('tagline') is-invalid @enderror" id="tagline"
                           placeholder="tagline" value="{{ old('tagline', $merchant->tagline) }}">
                    @error('tagline')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="longitude" class="form-control @error('longitude') is-invalid @enderror" id="longitude"
                           placeholder="longitude" value="{{ old('longitude', $merchant->longitude) }}">
                    @error('longitude')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="latitude" class="form-control @error('latitude') is-invalid @enderror" id="latitude"
                           placeholder="latitude" value="{{ old('latitude', $merchant->latitude) }}">
                    @error('latitude')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="national_identification_no" class="form-control @error('national_identification_no') is-invalid @enderror" id="national_identification_no"
                           placeholder="national_identification_no" value="{{ old('national_identification_no', $merchant->national_identification_no) }}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="passport_number" class="form-control @error('passport_number') is-invalid @enderror" id="passport_number"
                           placeholder="passport_number" value="{{ old('passport_number', $merchant->passport_number) }}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="business_registration_no" class="form-control @error('business_registration_no') is-invalid @enderror" id="business_registration_no"
                           placeholder="business_registration_no" value="{{ old('business_registration_no', $merchant->business_registration_no) }}">
                ...
                <div class="form-group">
                    ...
                    <?php if($merchant->national_identification_front):?>
                    <img src="{{$merchant->getNationalIdentificationPicFrontUrl()}}" width="70%" height="20%"/><br/><br/>
                ...
                <div class="form-group">
                    ...
                    <?php if($merchant->national_identification_back):?>
                    <img src="{{$merchant->getNationalIdentificationPicBackUrl()}}" width="70%" height="20%"/><br/><br/>
                ...
                <div class="form-group">
                    ...
                    <?php if($merchant->business_registration_cert):?>
                    <img src="{{$merchant->getBusinessRegistrationCertUrl()}}" width="70%" height="20%"/><br/><br/>
                ...
                <div class="form-group">
                    ...
                    <?php if($merchant->business_registration_cert):?>
                    <img src="{{$merchant->getRecentBankStatmtUrl()}}" width="70%" height="20%"/><br/><br/>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6" style="padding-left:0px" >                                
                            <select name="kyc_completed" class="form-control @error('kyc_completed') is-invalid @enderror" id="kyc_completed">
                                ...
                                <option value="0" @if ($merchant->kyc_completed == "0") {{ 'selected' }} @endif>No</option>
                                <option value="1" @if ($merchant->kyc_completed == "1") {{ 'selected' }} @endif>Yes</option>
                            </select>
                        @error('kyc_completed')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
