            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item menu-open">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <i class="far fa-circle nav-icon"></i>
                        <?php
                         $all_sales_count = App\Models\Order::where("deleted","=",0)->where("account_id", "=", $account_id)->count();
                        ?>
                ...
                <li class="nav-item menu-open">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            ...
                            <i class="far fa-circle nav-icon"></i>
                            <p>On Hold Internal</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('purchases.index') }}" class="nav-link {{ (request()->is('admin/purchases/onhold'))? 'active' : '' }}">
                            <i class="far fa-circle nav-icon"></i>
                            <p>Rejected Internal</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('purchases.index') }}" class="nav-link {{ (request()->is('admin/purchases/awaitapprv'))? 'active' : '' }}">
                            <i class="far fa-circle nav-icon"></i>
                            <p>Awaiting Supplier Approval</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('purchases.index') }}" class="nav-link {{ (request()->is('admin/purchases/awaitapprv'))? 'active' : '' }}">
                            <i class="far fa-circle nav-icon"></i>
                            <p>On Hold By Supplier</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('purchases.index') }}" class="nav-link {{ (request()->is('admin/purchases/awaitapprv'))? 'active' : '' }}">
